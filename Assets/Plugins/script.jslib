mergeInto(LibraryManager.library, {
  ...
  SaveLab: function (saveInput) {
    ...
    if (saveStr.length > 2000) {
      alert("Warning: Your lab is to big to save in a link and will be saved to a text file and will be downloaded to your computer. To load your lab, copy all of the text in the text file and paste it prompt from the Load Lab button. Click OK to download the file, or click cancel");
